...
class AssertTest extends TestCase {
    ...
    public function testValidateRouteSuccess() {
        ...
        $this->mcValidateRoute->validateRoute(['uri' => '', 'invoke' => 'eet->testf', 'method' => '']);
    }
}   